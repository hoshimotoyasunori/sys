...
DROP TRIGGER IF EXISTS trigger_create_initial_tasks_and_deliverables_trigger ON project_members;
DROP FUNCTION IF EXISTS create_initial_tasks_and_deliverables() CASCADE;
...
WHERE trigger_name = 'trigger_create_initial_tasks_and_deliverables'; 